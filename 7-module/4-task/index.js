...
export default class StepSlider {
  constructor({ steps, value = 0 }) {
    ...
    this.createSteps();
    this.setInitialValue(); // Обновляем состояние
  ...
  DnD() {
    ...
    thumb.onpointerdown = (event) => {
      ...
      document.onpointerup = () => {
        ...
        // Генерация события после окончания перетаскивания (либо тоже можно добавить в move)
        this.slider.dispatchEvent(new CustomEvent('slider-change', {
          detail: this.value,
          bubbles: true,
        }));
  ...
  updateSteps() {
    ...
    spans[this.value].classList.add('slider__step-active'); // Устанавливаем активный шаг
  }
